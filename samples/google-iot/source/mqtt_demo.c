...
static void prvMQTTEchoTask(void *pvParameters)
{
    ...
    /* connect to m2m.eclipse.org, subscribe to a topic, send and receive messages regularly every 1 sec */
...
#ifdef SECURE_SOCKET
       params.sec_method = SL_SO_SEC_METHOD_TLSV1_2;
       params.cipher = SL_SEC_MASK_TLS_RSA_WITH_AES_128_GCM_SHA256;
#endif
       if ((rc = NetworkConnect(&network, credentialsMQTT_BROKER, credentialsMQTT_BROKER_PORT, (void*)&params)) != 0)
       {
       ...
       connectData.username.cstring = credentialsMQTT_DEVICE_USER_ID;
       connectData.password.cstring = credentialsMQTT_DEVICE_PASSWORD;
